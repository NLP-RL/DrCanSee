...
multimodal_symp = ['Swollen eye','Skin growth','Eye redness','Skin dryness ','Redness in ear','Skin rash','Itchy eyelid','Hand or Finger lump or mass','Foot or toe swelling','Lip Swelling','Eyelid lesion or rash','Mouth Ulcer','Neck swelling','Skin irritation','Swollen or red tonsils','Knee swelling','Dry or flaky scalp']


multimodal_dict ={'S1':'Swollen eye','S4':'Skin growth','S5':'Eye redness','S11':'Skin dryness','S22':'Redness in ear','S31':'Skin rash','S37':'Itchy eyelid','S39':'Hand or Finger lump or mass','S50':'Foot or toe swelling','S51':'Lip Swelling','S74':'Eyelid lesion or rash','S108':'Mouth ulcer','S159':'Neck swelling','S177':'Skin irritation','S181':'Swollen or red tonsils','S205':'Knee swelling','S251':'Dry or flaky scalp'}
...
parser.add_argument('--MSymp', dest='MSymp', type=list, default=multimodal_symp, help='multimodal_symp')
parser.add_argument('--MDict', dest='MDict', type=dict, default=multimodal_dict, help='multimodal_dict')
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../../model/DQN/checkpoint/0114141450_agenthrljoint2_T22_ss100_lr0.0005_RFS66_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-66_mls0_gamma0.95_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_data_RID0/")
...
parser.add_argument("--image_prediction", dest="image_prediction", type=str, default=file0+'/FinalP/SD_DesneNet169CNN_Hierarchical.p.p',help='path and filename of user goal')
...
parser.add_argument("--reward_for_inform_wrong_disease", dest="reward_for_inform_wrong_disease", type=float, default=-55.0, help="The reward when the user denies the informed disease.")
parser.add_argument("--multi_GPUs", dest="multi_GPUs", type=boolean_string, default=True, help="")
...
parser.add_argument("--error_prob", dest="error_prob", type=float, default=0.0, help="Error probability when applying noisy channel?")
